...
print("[HYPERSIM: DATASET_SUBMIT_RENDERING_JOBS_DEADLINE] Begin...")
...
for s in scenes:
    ...
    for c in cameras:
        ...
        print("[HYPERSIM: DATASET_SUBMIT_RENDERING_JOBS_DEADLINE] Extracting all file references from " + vrscene_file + "...")
                ...
                for initial_token in cloud_pre_cache_files_initial_tokens:
                    if line.startswith(initial_token):
                        ...
                        if len(cloud_pre_cache_file_tokens) == 2:
                            ...
                            print("[HYPERSIM: DATASET_SUBMIT_RENDERING_JOBS_DEADLINE] WARNING: Couldn't understand filename in text: " + line)
        ...
        print("[HYPERSIM: DATASET_SUBMIT_RENDERING_JOBS_DEADLINE] Submitting job " + job_name + "...")

        deadline_con.Jobs.SubmitJob(job_info, plugin_info, auxiliary_files)



print("[HYPERSIM: DATASET_SUBMIT_RENDERING_JOBS_DEADLINE] Finished.")
